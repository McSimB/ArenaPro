...
public abstract class Class_116 extends Class_1e8 implements Runnable, CommandListener {
	...
	public Class_116(j var1) {
		...
		if (var3 != -1) {
			this.var_4a2 = 0 | var3 << 16 | var4 << 8 | var5;
		}
		...
		if (var3 != -1) {
			this.var_56f = 0 | var3 << 16 | var4 << 8 | var5;
		}
	...
	int sub_15() {
		if ((this.var_831 = super.var_96.sub_dc(5030)) == -1) {
			this.var_831 = 15;
		}
	...
	public void sub_e9a() {
		String var1 = super.var_96.sub_13f("cfg");
		if (var1 == null) {
			var1 = "1111";
		}
	...
	public void sub_ec7() {
		...
		for (int var2 = 0; var2 < this.var_8b4.length; ++var2) {
			var1 = var1 + (this.var_8b4[var2] ? '1' : '0');
		}

		super.var_96.sub_f0("cfg", var1, true);
	}
	...
	public void sub_2e9(int var1, boolean var2) {
		...
		if (var1 == this.var_6fb) {
			super.var_96.var_b4 = var2;
			if (!this.var_1df) {
				super.var_96.var_166 = var2;
				if (!var2) {
					this.sub_7a1(0);
				}
			}
			...
			super.var_96.var_e8 = var2;
		} else if (var1 == this.var_813) {
			super.var_96.var_105 = var2;
			this.sub_1e0(0, var2);
		}
	...
	public Image sub_11be(int var1) throws IOException {
		try {
			return Image.createImage("/_" + Integer.toHexString(var1).toUpperCase() + ".png");
		} catch (Exception var4) {
			byte[] var3 = a.sub_499(var1);
			if (var3 != null) {
	...
	public void run() {
		...
		if (var1 == this.var_207) {
			...
			try {
				...
				super.var_96.sub_4e9("initGame: " + var6);
			}
	...
	public synchronized void sub_1131(Graphics var1) {
	...
	public void sub_2d3() {
		...
		while (Thread.currentThread() == this.var_35) {
			...
			if (var_d3) {
				var_d3 = false;
				this.sub_359(super.var_96.sub_239(this.sub_1148()));
				this.var_3ef = 1;
			} else {
				try {
					this.sub_1fd(var3);
				} catch (Exception var9) {
					super.var_96.sub_4e9("update: " + var9);
					return;
				}
	...
	public void sub_30c(Displayable var1) {
		Display var2 = Display.getDisplay(super.var_96);
		if (var2 != null) {
	...
	public String sub_446(int var1) {
		return super.var_96.sub_383(var1);
	}

	public int sub_462(int var1) {
		return super.var_96.sub_dc(var1);
	}
