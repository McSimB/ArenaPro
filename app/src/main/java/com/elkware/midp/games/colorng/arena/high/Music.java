...
public class Music implements PlayerListener, LifeCycleListener {
    ...
    static int sound47_0; // die
    static int sound47_1;
    static int sound47_2;
    static int sound48;  // hit long in enemy
    static int sound49;  // hit short --
    static int sound4A;  // fire short
    static int sound4B;  // fire long
    ...
    public Music(Arena3 var1) {
        ...
        try {
            ...
            sound47_0 = soundPool.load(ContextHolder.getContext().getAssets().openFd("_47_0.mp3"), 1);
            sound47_1 = soundPool.load(ContextHolder.getContext().getAssets().openFd("_47_1.mp3"), 1);
            sound47_2 = soundPool.load(ContextHolder.getContext().getAssets().openFd("_47_2.mp3"), 1);
