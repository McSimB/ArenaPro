...
public interface HttpConnection {
	...
	public abstract void setRequestMethod(String s) throws IOException;
	...
	public abstract String getHeaderField(String s) throws IOException;

	public abstract int getHeaderFieldInt(String s, int i) throws IOException;

	public abstract long getHeaderFieldDate(String s, long l)
			throws IOException;

	public abstract String getHeaderField(int i) throws IOException;

	public abstract String getHeaderFieldKey(int i) throws IOException;
